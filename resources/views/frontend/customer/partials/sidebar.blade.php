<div class="col-lg-3">
  <div class="user-sidebar">
    <ul class="links">
      ...
      <li><a href="{{ route('venues.bookings') }}" class="@if (request()->routeIs('venues.bookings') || request()->routeIs('venues.bookings')) active @endif">
          {{ __('Venue Bookings') }} </a></li>
      ...
      <li><a href="{{ route('customer.edit.profile') }}"
          class="@if (request()->routeIs('customer.edit.profile')) active @endif">{{ __('
            Edit Profile') }} </a></li>
      ...
      <li><a href="{{ route('customer.logout') }}" onclick="return confirm('Are you sure you want to logout?')" class="">{{ __('Logout') }} </a></li>
    </ul>
  </div>
</div>
