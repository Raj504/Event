                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fname"
                                            value="{{ Auth::guard('customer')->user()->fname }}" id="fname"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lname"
                                            value="{{ Auth::guard('customer')->user()->lname }}" id="lname"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="country"
                                            value="{{ Auth::guard('customer')->user()->country }}" class="form-control"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="state"
                                            value="{{ Auth::guard('customer')->user()->state }}" class="form-control"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="zip_code"
                                            value="{{ Auth::guard('customer')->user()->zip_code }}" class="form-control"
                            ...
                            <div class="row mt-35">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="address">{{ __('Phone') . '*' }}</label>
                                        <input type="text" name="phone" id="phone" class="form-control"
                                            value="" placeholder="{{ __('Phone Number') }}">
                                        @error('phone')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-lg-6" id="shipping_address">
                            ...
                            <div class="row mt-35">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="fname">{{ __('First Name') . ' *' }}</label>
                                        <input type="text" name="s_fname" value="" id="fname"
                                            class="form-control" placeholder="{{ __('First Name') }}">
                                        @error('s_fname')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="lname">{{ __('Last Name') . '*' }}</label>
                                        <input type="text" name="s_lname" value="" id="lname"
                                            class="form-control" placeholder="{{ __('Last Name') }}">
                                        @error('s_lname')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="email">{{ __('Email') . '*' }}</label>
                                        <input type="text" name="s_email" id="email" value=""
                                            class="form-control" placeholder="{{ __('Email Address') }}">
                                        @error('s_email')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="cart-item-wrap pt-15">
                                        @foreach ($shipping_charges as $shipping_charge)
                                            <div class="alert fade show cart-single-item">
                                                <h6 class="product-name"><input type="radio"
                                                        value="{{ $shipping_charge->id }}"
                                                        data-id="{{ $shipping_charge->charge }}"
                            ...
                            <div id="couponReload">
                                <ul class="package-summary mb-25">
                                    ...
                                    @if (Session::get('Shop_discount') != '')
                                        <li><span class="text">{{ __('Discount') }}</span> <span class="number"
                                                dir="ltr"><span class="text-success">-</span>
                                                {{ $basicInfo->base_currency_symbol_position == 'left' ? $basicInfo->base_currency_symbol : '' }}
                                    ...
                                    @php
                                        ...
                                        $total_tax_amount =
                                            ($tax_percentage / 100) * ($cartTotal - Session::get('Shop_discount'));
                                    @endphp
                                    ...
                                    <li><span class="text">{{ __('Grand Total') }}</span> <span class="number"
                                            ...
                                            @php
                                                $charge =
                                                    Session::get('shipping_cost') != null
                            ...
                            <select name="gateway" id="payment">
                                ...
                                @php
                                    $offline_gateways = App\Models\PaymentGateway\OfflineGateway::where('status', 1)
                                        ...
                                        ->get();
                                    $online_gateways = App\Models\PaymentGateway\OnlineGateway::where(
                                        'status',
                                        1,
                                    )->get();
                                @endphp
