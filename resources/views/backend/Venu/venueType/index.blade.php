                            ...
                            <table class="table table-striped mt-3" id="basic-datatables">
                                ...
                                @foreach ($venuTypeData as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-secondary btn-xs mr-1 mt-1 editBtn" href="#" data-toggle="modal" data-target="#editVenuTypeModal_{{$data->id}}" data-id="{{ $data->id }}">
                                                <span class="btn-label">
                                                    <i class="fas fa-edit"></i>
                                                </span>
                                            </a>

                                            <form class="deleteForm d-inline-block" action="{{ route('admin.deleteVenueType', ['id' => $data->id]) }}" method="post">
                                    ...
                                    @include('backend.Venu.venueType.editVenueType')
...
@include('backend.Venu.venueType.createVenueType')
