  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner">
    <div class="sidebar-content">
      ...
      <ul class="nav nav-primary">
            ...
            <ul class="nav nav-collapse">
              ...
              ">
                <a href="{{ route('choose-event-type', ['language' => $defaultLang->code]) }}">
                  <span class="sub-item">{{ __('Add Banquat Hall') }}</span>
                </a>
              </li>
        ...
        <li class="nav-item @if (request()->routeIs('banquat.create') || request()->routeIs('banquat.index')) submenu active @endif">
            <a data-toggle="collapse" href="#banquat_hall">
                <i class="fal fa-book"></i>
                <p>Banquat Hall</p>
                <span class="caret"></span>
            </a>

            <div id="banquat_hall" class="collapse">
                <ul class="nav nav-collapse">
                    <li class=" @if (request()->routeIs('banquat.create')) active @endif">
                        <a href="{{route('banquat.create')}}">
                            <span class="sub-item">Add Banquat Hall</span>
                        </a>
                    </li>
                    
                    <li class=" @if (request()->routeIs('banquat.index')) active @endif">
                        <a href="{{route('banquat.index')}}">
                            <span class="sub-item">See Banquat Halls</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <li class="nav-item @if (request()->routeIs('organizer.packages.listing')) active
            @elseif (request()->routeIs('organizer.packages.create')) active @endif">
            ...
            <div id="packages"
              class="collapse
              @if (request()->routeIs('organizer.packages.listing')) show
              @elseif (request()->routeIs('organizer.packages.create')) show @endif">
              <ul class="nav nav-collapse">
                <li class="{{ request()->routeIs('organizer.packages.create') ? 'active' : '' }}">
                  <a href="{{ route('organizer.packages.create') }}">
                    <span class="sub-item">{{ __('Add Packages') }}</span>
                  </a>
                </li>
              </ul>
            </div>
