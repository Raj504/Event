...
class EventController extends Controller
{
  ...
  public function add_event()
  {
      // Initialize an array to hold information
      $information = [];
      ...
      // Get currency information (Assuming this method exists and fetches currency-related info)
      $information['getCurrencyInfo'] = $this->getCurrencyInfo();
  ...
  public function store(StoreRequest $request)
  {
    ...
    DB::transaction(function () use ($request) {
      ...
      foreach ($languages as $language) {
        ...
        $event_content->features = $request[$language->code . '_features'];
        $event_content->book_date = $request[$language->code . 'book_date'];
  ...
  {
      $event = Event::with('event_content')->findOrFail($id);
      $information = [
          'event' => $event,
          'languages' => Language::all(),
          'countries' => Country::all(),
          'cities' => City::where('country_id', $event->country)->orderBy('name', 'asc')->get(),
          'states' => State::where('country_id', $event->country)->orderBy('name', 'asc')->get(),
          'organizers' => Organizer::all(),
