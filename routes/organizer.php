...
Route::prefix('/organizer')->middleware('auth:organizer', 'Deactive:organizer', 'EmailStatus:organizer', 'adminLang')->group(function () {
  ...
  */
    ...
    |---------------------------------------------
    */
    Route::resource('banquat', App\Http\Controllers\BackEnd\Organizer\BanquatHallController::class);


    // @packages 
    Route::get('/packages/create', 'BackEnd\Organizer\OrganizerController@createPackage')->name('organizer.packages.create');
    Route::get('/packages/viewPackageData', 'BackEnd\Organizer\OrganizerController@viewPackageData')->name('organizer.packages.viewPackageData');
    Route::get('/packages/editPackageData', 'BackEnd\Organizer\OrganizerController@editPackageData')->name('organizer.packages.editPackageData');
    Route::get('/packages/removePackageData', 'BackEnd\Organizer\OrganizerController@removePackageData')->name('organizer.packages.removePackageData');
    Route::post('/packages/store', 'BackEnd\Organizer\OrganizerController@storePackage')->name('organizer.packages.store');
    Route::post('/packages/updatePackage', 'BackEnd\Organizer\OrganizerController@updatePackage')->name('organizer.packages.updatePackage');
    Route::post('/packages/storePackageMeta', 'BackEnd\Organizer\OrganizerController@storePackageMeta')->name('organizer.packages.storePackageMeta');
