...
Route::middleware('change.lang')->group(function () {
  ...
  // Route::get('/', 'FrontEnd\HomeController@showHomePage')->name('home');
  ...
  //Venues
  Route::get('venues', 'FrontEnd\VenueController@venues')->name('venues');
  Route::get('searched/venues/', 'FrontEnd\VenueController@searchBySlug')->name('venues.search');
  Route::post('date/searched/venues/', 'FrontEnd\VenueController@searchByDate')->name('venues.search.date');
  Route::get('venue/details/{id}','FrontEnd\VenueController@venueDetails')->name('venues.details');
  Route::post('venue/details/store','FrontEnd\VenueController@venueDetails1Store')->name('venues.details1.store');
  Route::get('venue/my-bookings','FrontEnd\VenueController@venueBookingShow')->name('venues.bookings');
  Route::get('/booking/venue-customer-details/{id}', 'FrontEnd\VenueController@venueCustomerDetails')->name('venue.booking_details');
...
// @payment of emi by client 
Route::get('pay/v1/secure/emi/{paymentId}', 'FrontEnd\PageController@paymentByClient')->name('paymentByClient');
