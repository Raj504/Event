...
Route::prefix('/admin')->middleware(['auth:admin', 'adminLang'])->group(function () {
  ...
  // Venue
    ...
    Route::get('venu_category','BackEnd\Venu\VenuController@VenuePage')->name('admin.venue');
    Route::post('store_venu_category','BackEnd\Venu\VenuController@storeVenuCategory')->name('admin.storeVenuCategory');
    Route::get('add_venue','BackEnd\Venu\VenuController@addVenue')->name('admin.addVenue');
    Route::post('store_venue','BackEnd\Venu\VenuController@storeVenue')->name('admin.storeVenue');
    Route::post('edit_venue','BackEnd\Venu\VenuController@editVenue')->name('admin.editVenue');
    Route::post('/admin/delete-venue/{id}', 'BackEnd\Venu\VenuController@deleteVenue')->name('admin.deleteVenue');
    Route::get('add_venue_type','BackEnd\Venu\VenuController@addVenueType')->name('admin.addVenueType');
    Route::post('store_venue_type','BackEnd\Venu\VenuController@storeVenueType')->name('admin.storeVenueType');
    Route::post('edit_venue_type','BackEnd\Venu\VenuController@editVenueType')->name('admin.editVenueType');
    Route::post('/admin/delete-venue_type/{id}', 'BackEnd\Venu\VenuController@deleteVenueType')->name('admin.deleteVenueType');
    Route::get('add_venue_service','BackEnd\Venu\VenuController@addVenueService')->name('admin.addVenueService');
    Route::post('store_venue_service','BackEnd\Venu\VenuController@storeVenueService')->name('admin.storeVenueService');
    Route::post('edit_venue_service','BackEnd\Venu\VenuController@editVenueService')->name('admin.editVenueService');
    Route::post('/admin/delete-venue_service/{id}', 'BackEnd\Venu\VenuController@deleteVenueService')->name('admin.deleteVenueService');
